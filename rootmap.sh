...
EOF
	...
	tput bold
	tput setaf 2
	printf "\t[-]\tDeveloper:\tROot_hex\t\t\t\t[-]\n"
	printf "\t[-]\tWebsite:\thttps://github.com/r00thex\t[-]\n"
	tput sgr0
	tput setaf 7
	printf "\t[-]\t\t\t*********\t\t\t[-]\n"
	tput sgr0
